'''
    ...
    Explanation Video: https://www.youtube.com/watch?v=rhKuVZSsU_Q
'''
...
class SkipList:
    ...
    '''
        ...
        @param elem: The element you want to insert into the list.
    '''
    ...
    '''
        ...
        @param elem: The element you want to delete from the list. 
    '''
